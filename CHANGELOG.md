...
- Added a blocking two-replica kind gate for single-leader enforcement, active-Pod failover, concurrent pool convergence, and post-failover allocation continuity.
...
### Fixed
- Updated cel-go to 0.29.0 so JSON-omitted native fields remain unavailable to CEL evaluation.
...
- Added a repository-owned linkedom-backed React Testing Library harness with local minimal CSSOM, HTML escaping, and property-hyphenation adapters for critical dashboard flows and split API state, explanation lifecycle, navigation, and tab rendering out of `App.tsx`.
...
[Unreleased]: https://github.com/oaslananka/draforge/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/oaslananka/draforge/compare/v0.2.0...v0.3.0
