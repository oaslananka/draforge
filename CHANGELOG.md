...
- Added a repository-owned linkedom-backed React Testing Library harness with a local minimal CSSOM adapter for critical dashboard flows and split API state, explanation lifecycle, navigation, and tab rendering out of `App.tsx`.
