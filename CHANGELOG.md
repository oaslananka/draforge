...
- Added a jsdom-based React Testing Library harness for critical dashboard flows and split API state, explanation lifecycle, navigation, and tab rendering out of `App.tsx`.
