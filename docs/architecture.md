...
The Node Plugin runs on each node, simulating kubelet plugin registration. It generates dynamic CDI (Container Device Interface) specification JSONs corresponding to allocations, enabling test containers to reference mock device IDs.
