...
node_image_arg='ARG NODE_IMAGE=node@sha256:16e22a550f3863206a3f701448c45f7912c6896a62de43add43bb9c86130c3e2'
node_base="FROM \${NODE_IMAGE} AS frontend-builder"
...
assert_contains "$dockerfile" "$node_image_arg"
